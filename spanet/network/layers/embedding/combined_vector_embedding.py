...
from spanet.network.layers.embedding.global_vector_embedding import (
    GlobalVectorEmbedding,
)
from spanet.network.layers.embedding.relative_vector_embedding import (
    RelativeVectorEmbedding,
)
from spanet.network.layers.embedding.sequential_vector_embedding import (
    SequentialVectorEmbedding,
)
...
class CombinedVectorEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.vector_embeddings = self.embedding_class(input_type)(
            options, self.num_input_features
        )
