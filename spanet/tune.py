...
try:
    ...
    print(
        'Tuning script requires additional dependencies. Please run: pip install "ray[tune]" hyperopt'
    )
    exit()
...
def tune_spanet(
    ...
    scheduler = ASHAScheduler(
        max_t=num_epochs, grace_period=num_epochs // 4, reduction_factor=2
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--num_trials", type=int, default=10, help="Number of trials to run."
    )
